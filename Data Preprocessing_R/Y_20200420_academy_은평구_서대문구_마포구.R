...
# 데이터 불러오기
academy_data <- readxl::read_excel("../Data/collectData/Y_academy_east_north.xlsx", sheet = "은평구 서대문구 마포구 학원현황")
...
# CSV로 저장
write.csv(academy_data3, "../Data/preprocessingData/Y_academy_은평구_서대문구_마포구.csv", row.names = FALSE)
