...
# 데이터 불러오기
academy_data <- readxl::read_excel("../Data/collectData/Y_academy_관악_성북.xlsx", sheet = "성동구 광진구 학원현황")
...
# CSV로 저장
write.csv(academy_data3, "../Data/preprocessingData/Y_academy_성동구_광진구.csv", row.names = FALSE)
