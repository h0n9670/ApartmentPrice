...
# 데이터 불러오기
mart_data <- read.csv("../Data/collectData/N_20200421_distance_data/N_20200421_서울시 이마트.csv")
# 중복값 제거
...
# CSV로 저장
write.csv(mart_data3, "../Data/preprocessingData/H_Seoul_EMART.csv", row.names = FALSE)

#읽는거 확인하기
read.csv("C:\\Users\\USER\\Documents\\ApartmentPrice\\Data\\preprocessingData\\H_Seoul_EMART.csv")
