...
# 데이터 불러오기
academy_data <- readxl::read_excel("../Data/collectData/Y_academy_east_north.xlsx", sheet = "영등포구 구로구 금천구 학원현황")
...
# CSV로 저장
write.csv(academy_data3, "../Data/preprocessingData/Y_academy_영등포구_구로구_금천구.csv", row.names = FALSE)
