...
# 데이터 불러오기
academy_data <- readxl::read_excel("../Data/collectData/Y_academy_east_north.xlsx", sheet = "도봉구 노원구 학원현황")
...
# CSV로 저장
write.csv(academy_data3, "../Data/preprocessingData/Y_academy_도봉구_노원구.csv", row.names = FALSE)
