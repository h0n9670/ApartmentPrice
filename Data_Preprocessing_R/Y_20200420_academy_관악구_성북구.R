...
# 데이터 불러오기
academy_data <- readxl::read_excel("../Data/collectData/Y_academy_관악_성북.xlsx", sheet = "동작구 관악구 학원현황")
...
# CSV로 저장
write.csv(academy_data3, "../Data/preprocessingData/Y_academy_관악구_성북구.csv", row.names = FALSE)
